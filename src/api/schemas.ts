...
export const BlocksEntryHeaderSchema = Type.Object({
...
export type BlocksEntryHeader = Static<typeof BlocksEntryHeaderSchema>;
...
export const BlockEntrySchema = Type.Union(
  [BlocksEntryHeaderSchema, Type.Composite([BlocksEntryHeaderSchema, BlocksEntrySignerDataSchema])],
  { description: 'Signer related data can by null if it was not detected by the monitor service' }
);
